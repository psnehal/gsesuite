...
public class ChipEnrichPeaks {
	...
	public ChipEnrichPeaks(String chrom, String peakS, String peakE, String pmid, String geneid, String geneSym, String lstart, String lend, String ntss, String dtss, String ntssgene, String tssgs, String ntssgenestrand, String log_dtss, String loggene, String scaled_dtss) {
		this.chrom = chrom;
		this.peakS = peakS;
		this.peakE = peakE;
		this.pmid = pmid;

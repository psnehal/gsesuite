...
#tooltip p {
    ...
    <title>Clustergrammer.js</title><asset:javascript src="d3.js"/>
    ...
    d3.tsv("/Users/snehalpatil/Documents/GithubProjects/gsesuite/gsesuite/grails-app/assets/javascripts/data_heatmap.txt",
    function(d) {
    return {
    row:   +d.row_idx,
    col:   +d.col_idx,

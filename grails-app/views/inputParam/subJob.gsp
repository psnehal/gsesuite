                    ...
                    <g:form action="subJob" method="post" id="upform" name="upform"
                                        ...
                                        <td><input type="file" name="myfile" id="myFile" multiple size="50" onchange="myFunction2()">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <ul>
                                                        <g:each in="${list}">
                                                            <li> <a class="dropdown-item" href="#">${it.name}</a></li>
                                                        </g:each>
                                                    </ul>
                                                </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion"
                                       href="#collapse2"><span class="contentTitle">Step 2: Find the Optimal Test</span></a>
                                </h4>
                            </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion"
                                       href="#collapse3"><span
                                            class="contentTitle">Step 3: Choose a Locus Definition (the set of regulatory regions and their target genes)</span>
                                    </a>
                                </h4>
                            </div>
                                                ...
                                                <div id="locusdefinations">
                                                    <ul class="b">
                                                        ...
                                                        <li><input type="radio" name="ld" value="nearest_gene"
                                                                ...
                                                                class="formText2">Nearest Gene<br/><img style="max-width:300px; margin-top: -7px;"
                                                                                                        src="${resource(dir: 'images', file: 'neargene.png')}"></span><br/>
                                                    ...
                                                    <div id="assocRules" style="display:none">
                                                        <ul class="b">
                                                            <li><input type="radio" name="ld" value="1kb"/><span class="formText2">< 1kb <br/><img style="max-width:150px; margin-top: -7px;" src="${resource(dir: "images", file: "1kb.png")}"></span><br/>
                                                                <span class="footnote">(only use peaks within 1kb of a transcription start site)</span>
                                                            </li>
                                                            <li><input type="radio" name="ld" value="5kb"/><span class="formText2">< 5kb <br/><img style="max-width:180px; margin-top: -7px;" src="${resource(dir: "images", file: "5kb.png")}"></span><br/>
                                                                <span class="footnote">(only use peaks within 5kb of a transcription start site)</span>
                                                            </li>
                                                            <li><input type="radio" name="ld" value="10kb"/><span class="formText2">< 10kb <br/><img style="max-width:210px; margin-top: -7px;" src="${resource(dir: "images", file: "10kb.png")}"></span><br/>
                                                                <span class="footnote">(only use peaks within 10kb of a transcription start site)</span>
                                                            </li>
                                                            <li><input type="radio" name="ld" value="10kboutside"/><span class="formText2">> 10kb and more upstream <br/><img style="max-width:200px; margin-top: -7px;"src="${resource(dir: "images", file: "10kboutside.png")}"></span><br/>
                                                                <span class="footnote">(only use peaks within 10kb and more upstream of a transcription start site)</span>
                                                            </li>
                                                            <li><input type="radio" name="ld" value="exon" onClick="warnForFet(this)"/><span class="formText2">Exon <br/> <img style="max-width:200px; margin-top: -7px;"src="${resource(dir: "images", file: "exon.png")}"></span><br/>
                                                                <span class="footnote">(only use peaks that fall within an annotated exon)</span>
                                                            </li>
                                                            <li><input type="radio" name="ld" value="intron" onClick="warnForFet(this)"/><span class="formText2">Intron <br/><img style="max-width:200px; margin-top: -7px;" src="${resource(dir: "images", file: "intron.png")}"></span><br/>
